<template>
  <body
    class="leading-normal tracking-normal text-white gradient hero-image"
      ...
      >
        <div class="pl-4 flex items-center">
          ...
          >
            ...
            <img
              class="w-24"
              src="https://static1.squarespace.com/static/6017fe99c360987af4f9262c/t/60206b197febbd1794f7860a/1612763324708/?format=1500w"
              alt=""
            />
          </a>
        </div>
    ...
    <div class="pt-32">
      ...
      >
        ...
        >
          ...
          <h1 class="my-4 text-5xl font-bold leading-tight pt-12">
            TANTANCHENG TAX & ACCOUNTING
          </h1>
          <h1 class="leading-normal text-2xl mb-8 w-full">腾诚会计师事务所</h1>
          <button
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <!-- <img class="w-full md:w-4/5 z-50" src="../assets/big.jpg" /> -->
        </div>
      </div>
    </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-full p-6">
            <p class="text-gray-600 mb-8">
              Headquartered in Flushing, TanTanCheng LLC represents a wide
              variety of clients from various industries. We believe in the
              value of relationships. We view every client relationship like a
              partnership, and truly believe that our success is a result of
              your success.
            </p>
            <p class="text-gray-600 mb-8">
              We help them achieve their maximum bottom line, save taxes and
              preserve wealth. We provide consistent, thoughtful and
              difference-making accounting, tax and consulting services. We
              listen and provide the services they want and need to reach their
              goals. Our clients have trusted our professionals as advisors and
              partners who deliver timely and precise work to keep clients
              informed as laws and accounting practices change.
            </p>
            <p class="text-gray-600 mb-8">
              We are committed to providing close, personal attention to our
              clients. We take pride in giving you the assurance that the
              personal assistance you receive comes from years of advanced
              training, technical experience and financial acumen. Those who
              choose our firm rely on competent advice and fast, accurate
              personnel. We provide total financial services to both individuals
              and small businesses.
            </p>
            <p class="text-gray-600 mb-8">
              Our team has over a decade of experience across Big 4 accounting
              firms. Get in touch with us to set up a consultation, or use the
              contact form at the bottom of this page to enquire whether our
              services are right for you. No one likes tax season, but we're
              here to make it easier. Whether you need help with your personal
              or business filings, there's nothing we can't do for you.
            </p>
          </div>
        </div>
        <h1
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              38-08 Union Street #11D Flushing, NY 11354
            </p>
            <h3 class="text-2xl text-gray-800 font-bold leading-none mb-3">
              ☎ CONTACT 联系方式
            </h3>
            <p class="text-gray-600 mb-8">
              Email: info@tantancheng.com Phone: (718) 683-9105
            </p>
            <h3 class="text-2xl text-gray-800 font-bold leading-none mb-3">
              🕛 OFFICE HOURS 办公时间
            </h3>
            <p class="text-gray-600 mb-8">
              Monday - Friday: 10AM - 6PM Saturday - Sunday: 12PM - 5PM
            </p>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full font-bold text-xl text-gray-800 px-6 py-8">
                INDIVIDUAL TAXES
              </div>
              <p class="text-gray-800 text-base px-6 mb-5">
                An individual income tax (or personal income tax) is levied on
                the wages, salaries, investments, or other forms of income an
                individual or household earns. The U.S. imposes a progressive
                income tax where rates increase with income.
              </p>
            </a>
          </div>
          <div
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                All businesses except partnerships must file an annual income
                tax return. Partnerships will file an informational return. The
                form you use depends on how your business is organized. A
                business may also have other filing requirements which includes
                but are not limited to sales and use tax, payroll tax and etc.
              </p>
            </a>
          </div>
          <div
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                ...
                Tax planning is an essential element of the tax preparation
                process. We will alert you to new developments in the tax laws
                that will help you to minimize both your current and future tax
                liabilities.
              </p>
            </a>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Businesses rely on well-organized and accurate financial records
                in order to maintain profitability and ensure that operations
                will run more efficiently on a daily basis. We will help your
                business get closer to these goals with accurate record keeping
                and support on various financial issues.
              </p>
            </a>
          </div>
          <div
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Accurate record-keeping is essential to a successful business.
                We will assist you with the organization and day-to-day
                bookkeeping in order to produce accurate records. Good financial
                data from financial projections will assist you in making the
                best business decisions and guide you to a successful operation.
              </p>
            </a>
          </div>
          <div
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          >
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full font-bold text-xl text-gray-800 px-6 py-8">
                BUSINESS INCORPORTION
              </div>
              <p class="text-gray-800 text-base px-6 mb-5">
                Choosing the form of business entity (ex: “S” corporation, “C”
                corporation, Limited Liability Company, etc.) has a large impact
                on your taxes and other liabilities. We will advise you on
                choosing an entity type and later restructuring if advantageous
...
<style>
.hero-image {
  background-image: url("https://images.unsplash.com/photo-1554224155-a1487473ffd9?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"); /* The image used */
...
@media (min-width: 1200px) {
  .hero-image {
    background-image: url("https://s3.ax1x.com/2021/02/09/ya6jBV.jpg"); /* The image used */
    background-color: #cccccc; /* Used if the image is unavailable */
    height: 650px; /* You must set a specified height */
    background-position: center; /* Center the image */
    background-repeat: no-repeat; /* Do not repeat the image */
